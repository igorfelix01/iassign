...
if ($action == 'view') {
  ...
  if ($iassign_ilms) {
    foreach ($iassign_ilms as $ilm) {
      ...
      $str .= '<tr>';
      $str .= '<td class="header c1" width=75% title="fields: name, description"><strong>' . $ilm->name . '<br/>' .
              iassign_language::get_description_lang(current_language(), $ilm->description) . '</strong></td>' . chr(13);
