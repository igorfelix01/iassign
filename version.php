...
$plugin->release = '2.3.00 (Build: 2017120100)'; //'2.2.00 (Build: 2017042800)'; // Human-readable version name
$plugin->version = 2017120100;                   // 2017042800;                  // The current module version (Date: YYYYMMDDXX)
