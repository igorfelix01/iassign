 ...
 * 
 * @see settings_ilm.php : process this form
 * 
...
class mod_ilm_form extends moodleform {
  ...
  //]]>
      ...
      if ($CFG->action_ilm != 'add') {
        ...
        $mform->addElement('static', 'file_jar_static', get_string('fields_info', 'iassign')); // only a text
        ...
        $mform->addHelpButton('file_class', 'file_class_form_help', 'iassign'); // first => field name; second => text to be presented
